        ...
        >
            <Link to={`/project/${project.id}`} className="block w-full h-full">
                <img
                    ...
                    loading="lazy"
                />
                <div className="absolute inset-0 bg-[#f61067]/90 opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex flex-col items-center justify-center p-4 text-center">
                    <h3 className="text-xl font-medium text-white mb-2 translate-y-4 group-hover:translate-y-0 transition-transform duration-300">
                        {project.title}
                    </h3>
