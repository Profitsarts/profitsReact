...
const ProjectNavBar = ({ prevProject, nextProject, isFirst, isLast }) => {
    return (
        <div className="sticky top-0 z-[100] bg-[#f8f8f8]/95 backdrop-blur-sm border-y border-dotted border-[#939fb0]">
