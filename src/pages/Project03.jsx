...
export default function Project03() {
  ...
  // But we want to keep the layout context
  const projectIndex = projects_v2.findIndex(p => p.id === "03")
    ...
    <div className="bg-[#f8f8f8] min-h-screen pb-20">
      ...
      <div className="max-w-5xl mx-auto px-6">
        <div className={styles.pageWrapper}>
          ...
          <p className={styles.kicker}>Product Design · SaaS · B2B</p>
          <h1 className={styles.h1}>FMS: Maintenance Management</h1>
          <p className={styles.subtitle}>
            Unifying service planning and compliance verification
            into a high-density calendar workspace.
          </p>

          {/* COVER IMAGE: Full Width */}
          <figure className={styles.figure}>
            <img
              src="assets/img/portfolio/full/08-maintenance-00-FULL.jpg"
              alt="FMS Dashboard"
              data-zoomable
              className={styles.figureImg}
            />
            <figcaption className={styles.caption}>
               Architected a calendar-grid maintenance workspace for Jungheinrich's Enterprise FMS.
            </figcaption>
          </figure>
